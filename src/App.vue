        ...
        <v-container fill-height>
          <div class="dogs-overlay">
            ...
            <v-img 
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn icon @click="addToFavourites" :disabled="isAlreadyInFavourites">
            ...
            <v-container grid-list-md fluid>
              ...
              tag="v-layout"
              class="wrap">
                  <v-flex xs6 sm4 md2 v-for="(pet, index) in favouriteDogs" :key="pet">
                    <app-dog :dog="pet" @remove=removeFromFavourites(index)></app-dog>
                  </v-flex>
              </transition-group>
            </v-container>
          </div>
